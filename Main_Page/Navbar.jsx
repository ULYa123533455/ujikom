    ...
    <>
      <header data-aos="fade-down" data-aos-duration="300" className="sticky">
        ...
        <NavLink
          ...
          data-aos-duration="700"
          to="/loginwithcaptcha"
          className={`button rounded ${isActive("/loginwitchcaptcha")}`}
          onClick={() => handleButtonClick("loginwitchcatpcha")}
        >
          <span
            className={`icon-login ${isActive("/loginwithcaptcha") ? "" : "inverse"}`}
          ></span>
          <span className={isActive("/loginwithcaptcha") ? "text-black" : ""}>
            login
          </span>
